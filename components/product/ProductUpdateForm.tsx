...
const ProductUpdateForm: React.FC<ProductUpdateFormProps> = (
	...
	const [tagId, setTagId] = useState<number | null>(props.product?.tagId || null);
		...
		<div className="container mt1">
			<article>
				<header>
					...
					<p>
						Voeg een product toe of pas een bestaand product aan zodat je het aan
						evenementen kan koppelen.
					</p>
				</header>
				<form>
